        ...
        if killed_pids:
            ...
            for pid in killed_pids:
                try:
                    ...
                    pass
            print(f"[Cleanup] Terminated SijulyVPN OpenVPN processes: {killed_pids}", flush=True)
    except Exception as e:
...
<body>
  <div class="login-container">
    <div class="login-card">
      ...
      <h2 class="login-title">SijulyVPN</h2>
